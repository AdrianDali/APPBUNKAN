...
//con que pagina va a iniciar para eso cirve initialroutename
// inavtivetint color es el color de las letras cuando no este seleccionado


//con tab bar icon dependiendo de la ruta pondra el icono especifico
const TabBar = () => {
    ...
    return(
        ...
        <Tab.Navigator
            ...
            tabBarOptions={{inactiveTintColor:"#fff",
                            activeTintColor:"#fff",
                            style:{
...
/**navigation container es para que nuestra tabbar sea de forma global!!! */
